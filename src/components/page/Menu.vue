            ...
            <el-form ref="addForm" :model="addObj" :rules="addFormRules" label-width="100px">
                ...
                <el-form-item label="上级菜单" prop="pid">
                    <el-select v-model="addObj.pid">
                        <el-option v-for="menu in parentMenSelect" :key="menu.id" :value="menu.id" :label="menu.name">{{menu.name}}</el-option>
                    </el-select>
                </el-form-item>
...
<script>
    import {loadTree,loadPageData,loadParent,addMenu,editMenu,deleteMenu} from "../../api/menu";
